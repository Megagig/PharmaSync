import { z } from 'zod';
import { ExpenseCategory, ExpenseStatus, PaymentMethod, RecurrenceInterval } from '../interfaces/expense.interface';
...
export const expenseSchema = z.object({
  ...
  paymentReference: z.string().max(50, 'Payment reference must be less than 50 characters').optional(),
