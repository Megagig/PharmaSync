...
router
  ...
  .get(getAccounts)
  .post(
    restrictTo(RoleType.ADMIN, RoleType.MANAGER),
...
router
  ...
  .post(
    restrictTo(RoleType.ADMIN, RoleType.MANAGER, RoleType.ACCOUNTANT),
...
router
  ...
  .get(getGeneralLedgerEntries);

router
  .route('/general-ledger/account/:id')
