 ...
 * @access  Private
 */
export const getAllShifts = asyncHandler(
 ...
 * @access  Private
 */
export const getShiftById = asyncHandler(
  async (req: Request, res: Response) => {
...
export const deleteShift = asyncHandler(async (req: Request, res: Response) => {
  ...
  await ScheduleShift.findByIdAndDelete(shift._id);
 ...
 * @access  Private
 */
export const getAllTimeOffRequests = asyncHandler(
  async (req: Request, res: Response) => {
    const page = parseInt(req.query.page as string) || 1;
 ...
 * @access  Private
 */
export const getTimeOffRequestById = asyncHandler(
  async (req: Request, res: Response) => {
 ...
 * @access  Private
 */
export const createTimeOffRequest = asyncHandler(
  async (req: Request, res: Response) => {
 ...
 * @access  Private/Admin
 */
export const updateTimeOffRequestStatus = asyncHandler(
  async (req: Request, res: Response) => {
 ...
 * @access  Private
 */
export const deleteTimeOffRequest = asyncHandler(
  async (req: Request, res: Response) => {
    const timeOffRequest = await TimeOffRequest.findById(req.params.id);
    ...
    await TimeOffRequest.findByIdAndDelete(timeOffRequest._id);
