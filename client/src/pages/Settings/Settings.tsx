              ...
              <div className="space-y-4">
                <div>
                  <label className="flex items-center">
                    <span className="mr-3 text-sm font-medium text-gray-700">Theme:</span>
                    <div className="relative inline-block w-10 mr-2 align-middle select-none">
                      ...
                      <div className={`absolute left-1 top-1 bg-white rounded-full h-4 w-4 transition-transform ${theme === 'dark' ? 'transform translate-x-6' : ''}`}></div>
                    </div>
                    <span className="text-sm text-gray-700">{theme === 'dark' ? 'Dark' : 'Light'}</span>
                  </label>
                </div>
