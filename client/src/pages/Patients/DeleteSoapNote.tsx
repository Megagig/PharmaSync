...
import { fetchPatientById, removeSoapNote, setError } from '@/store/slices/patientSlice';
import { SoapNote } from '@/types/patient.types';
import Card from '@/components/common/Card/Card';
import Button from '@/components/common/Button/Button';
import { formatDate } from '@/utils/date.utils';

const DeleteSoapNote = () => {
  ...
  const handleDelete = async () => {
    if (id && noteId) {
      try {
        ...
        if (removeSoapNote.fulfilled.match(resultAction)) {
          navigate(`/patients/${id}`);
        }
      } catch (error) {
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-2xl font-semibold text-gray-900">Delete SOAP Note</h1>
      </div>
      ...
      <Card>
        <div className="p-4">
          ...
          <div className="space-y-3 mb-6">
            ...
            <div className="flex justify-between">
              <span className="text-sm font-medium text-gray-500">Subjective</span>
